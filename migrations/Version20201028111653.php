 ...
 */
final class Version20201028111653 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student ADD classroom_id INT DEFAULT NULL, CHANGE ncs ncs INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (ncs)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student DROP classroom_id, CHANGE ncs ncs INT NOT NULL');
    }
}
