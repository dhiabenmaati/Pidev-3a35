 ...
 */
final class Version20210331010226 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, livreur_id INT DEFAULT NULL, user_id INT NOT NULL, date_creer DATE NOT NULL, date_expedirer DATE DEFAULT NULL, status INT NOT NULL, INDEX IDX_6EEAA67DF8646701 (livreur_id), INDEX IDX_6EEAA67DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
